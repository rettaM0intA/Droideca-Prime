...
public class ChangeIntakePositionsCommand extends InstantCommand {
   ...
   * @param desiredStateNumber set to the number that matches the state you want
   ...
   */
  public ChangeIntakePositionsCommand(int desiredStateNumber) {

    desiredState = desiredStateNumber;
